(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-1")) new core(".swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".wrapper-destination__count-end");
                    allSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".wrapper-destination__count-start");
                    currentSlide.innerHTML = swiper.activeIndex + 1;
                }
            }
        });
        if (document.querySelector(".swiper-2")) new core(".swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".wrapper-destination__count-end-2");
                    allSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".wrapper-destination__count-start-2");
                    currentSlide.innerHTML = swiper.activeIndex + 1;
                }
            }
        });
        if (document.querySelector(".swiper-3")) new core(".swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".wrapper-destination__count-end-3");
                    allSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".wrapper-destination__count-start-3");
                    currentSlide.innerHTML = swiper.activeIndex + 1;
                }
            }
        });
        if (document.querySelector(".swiper-plans")) new core(".swiper-plans", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".plans__count-end");
                    allSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".plans__count-start");
                    currentSlide.innerHTML = swiper.activeIndex + 1;
                }
            }
        });
        ...
        function pageNavigationAction(e) {
            if ("click" === e.type) {
                ...
                if (targetElement.closest("[data-goto]")) {
                    const gotoLinkAll = document.querySelectorAll("[data-goto]");
                    gotoLinkAll.forEach((link => {
                        link.classList.remove("active");
                    }));
                    const gotoLink = targetElement.closest("[data-goto]");
                    gotoLink.classList.add("active");
